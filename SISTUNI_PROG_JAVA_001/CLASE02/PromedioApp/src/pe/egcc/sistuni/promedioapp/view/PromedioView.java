...
public class PromedioView extends javax.swing.JFrame {
    ...
    private void cargarPaneles(){
      jTabbedPane1.addTab("2 Num", new Panel2Num());
      jTabbedPane1.addTab("3 Num", new Panel3Num());
      jTabbedPane1.addTab("4 Num", new Panel4Num());
      jTabbedPane1.addTab("5 Num", new Panel5Num());
    }
